        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <form method="POST" action="{{ route('product-category.update', [ 'product_category' => Crypt::encrypt($product_category->category_id) ]) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input id="category_name" type="text" class="form-control @error('category_name') is-invalid @enderror" name="category_name" value="{{ $product_category->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input id="category_description" type="text" class="form-control @error('category_description') is-invalid @enderror" name="category_description" value="{{ $product_category->description }}"  required autocomplete="name" autofocus>
